...
let CreateTodoController = class CreateTodoController extends index_1.Controller {
    ...
    execute(model) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let todo = yield this._todoManager.addTodo(model.title, model.description);
...
CreateTodoController = __decorate([
    index_1.command,
    index_1.route(Routes.createTodo),
